...
char *test_create_array() {
  ...
  assert_ints_equal(array_limit(array), 32, "limit");
...
char *test_array_push_until_expansion() {
  ...
  assert_ints_equal(array_limit(array), 128, "limit");
...
char *test_array_set_at_index() {
  ...
  assert_ints_equal(array_limit(array), 128, "limit after setting above current limit");
  assert_ints_equal(array_length(array), 33, "length");
